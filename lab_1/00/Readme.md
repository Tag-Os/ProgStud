...
Есть словарь координат городов,необходимо составить словарь расстояний между ними.

## описание работы

Создан новый словарь с помощью цикла for

## результат работы программы

![Результат](../images/00_Result.jpg)
